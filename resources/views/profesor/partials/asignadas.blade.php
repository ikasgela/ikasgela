        ...
        <table class="table table-hover">
            ...
            @foreach($actividades as $actividad)
                <tr class="table-cell-click"
                    ...
                    <td class="text-center clickable">{!! $actividad->is_expired ? (!$actividad->tarea->is_completada ? '<i class="fas fa-exclamation-triangle text-warning"></i>' : '<i class="fas fa-exclamation-triangle text-secondary"></i>') : '<i class="fas fa-times text-secondary"></i>' !!}</td>
