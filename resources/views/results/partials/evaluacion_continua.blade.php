...
<div class="card-deck">
    <div
        class="card mb-3 {{ $num_actividades_obligatorias > 0 ? $actividades_obligatorias_superadas ? 'bg-success text-white' : 'bg-warning text-dark' : 'bg-light text-dark' }}">
        <div
    ...
    @endif
    <div
        class="card mb-3 {{ ($actividades_obligatorias_superadas || $num_actividades_obligatorias == 0)
