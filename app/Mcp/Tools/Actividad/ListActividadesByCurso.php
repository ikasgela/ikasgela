...
#[Description('Listar actividades filtradas por curso_id (a través de la unidad). Devuelve id, nombre, descripcion, puntuacion, plantilla, orden y fecha_disponibilidad de cada actividad.')]
#[IsReadOnly]
class ListActividadesByCurso extends Tool
{
    public function handle(Request $request): Response
    {
        ...
        $actividades = Actividad::query()
            ->whereHas('unidad', function ($query) use ($validated) {
